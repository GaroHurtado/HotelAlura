...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		btnRegistro.setBackground(new Color(4, 47, 104));
		...
		btnBusqueda.setBackground(new Color(4, 47, 104));
		...
		lblNewLabel_4.setBackground(new Color(4, 47, 104));
		lblNewLabel_4.setHorizontalAlignment(SwingConstants.TRAILING);
		lblNewLabel_4.setIcon(new ImageIcon(MenuUsuario.class.getResource("/ImagenesIA/image (17).png")));
		lblNewLabel_4.setBounds(0, 0, 257, 609);
	    ...
	    panelFecha.setBackground(new Color(6, 70, 138));
