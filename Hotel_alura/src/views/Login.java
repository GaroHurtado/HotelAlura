...
public class Login extends JFrame {
	...
	public Login() {
		...
		panel_1.setBounds(436, 0, 352, 527);
		panel.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel imgHotel = new JLabel("");
		imgHotel.setHorizontalAlignment(SwingConstants.CENTER);
		imgHotel.setBounds(0, 0, 352, 527);
		panel_1.add(imgHotel);
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/ImagenesIA/image (14).png")));
	...
	private void entrada() {
		...
		login.verificacion(txtUsuario.getText(), String.valueOf(txtContrasena.getPassword()));
