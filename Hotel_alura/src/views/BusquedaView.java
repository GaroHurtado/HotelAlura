...
import Controllers.EliminarController;
...
public class BusquedaView extends JFrame {
	...
	private BusquedaController mostrar;
	private BusquedaController mostrarHuesped;
	private EliminarController eliminar;
	int xMouse, yMouse;
	...
	public BusquedaView() {
		...
		lblNewLabel_4.setBounds(314, 62, 329, 42);
		...
		modelo.addColumn("Fecha Check In (YYYY-MM-DD)");
		...
		if(scroll_table.isVisible()) {
			mostrar = new BusquedaController();
			mostrar.tablaReserva(modelo);
		}
		...
		if(scroll_tableHuespedes.isVisible()) {
			mostrarHuesped = new BusquedaController();
			mostrarHuesped.tablaHuesped(modeloHuesped);
		...
		btnbuscar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				//mostrar.borrarTabla(modelo);
				//mostrar.borrarTablaHuesped(modeloHuesped);
				mostrar = new BusquedaController();
				mostrar.busquedaReserva(txtBuscar.getText(), scroll_table,modelo,scroll_tableHuespedes, modeloHuesped);
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				eliminar.eliminarReserva(modelo, tbReservas);
		...
		JLabel lblNewLabel_4_1 = new JLabel("Ingresa numero de reserva:");
		lblNewLabel_4_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_4_1.setForeground(new Color(12, 138, 199));
		lblNewLabel_4_1.setFont(new Font("Dialog", Font.BOLD, 12));
		lblNewLabel_4_1.setBounds(369, 120, 164, 42);
